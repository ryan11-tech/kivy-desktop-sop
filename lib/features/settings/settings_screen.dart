        ...
        children: [
          ...
          _SettingsCard(
            children: [
              ...
              // Primary color
              _FieldLabel(text: 'PRIMARY COLOR'),
              const SizedBox(height: 8),
              Row(
                children: [
                  Expanded(
                    child: TextField(
                      controller: TextEditingController(text: _primaryHex),
                      ...
                      onChanged: (v) => setState(() => _primaryHex = v),
                    ),
                  ),
                ...
                children:
                    const [
                      ...
                      return GestureDetector(
                        onTap: () => setState(() => _primaryHex = hex),
                        child: Container(
                          width: 40,
                          height: 40,
                          decoration: BoxDecoration(
